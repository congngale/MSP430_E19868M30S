...
//---------- Pins for LoraModule --------------------
#define SPIPORTCLK	GPIO_PORT_P5 //port 5.2
#define SPICLK		GPIO_PIN2
#define SPIPORTDATA	GPIO_PORT_P5 //port 5
#define SPITX		GPIO_PIN0
#define SPIRX		GPIO_PIN1

#define LORA_PORT	GPIO_PORT_P8 //port 8
#define LORA_CSPIN	GPIO_PIN3
#define LORA_IVTXD	GPIO_PIN1
